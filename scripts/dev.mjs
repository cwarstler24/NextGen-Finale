...
const mkdocsConfigPath = path.join(rootDir, 'mkdocs.yml');
...
if (existsSync(mkdocsConfigPath)) {
	console.log('[dev] Starting MkDocs on http://127.0.0.1:8001');
	startProcess('python', ['-m', 'mkdocs', 'serve', '-f', 'mkdocs.yml', '--dev-addr', '127.0.0.1:8001']);
} else {
